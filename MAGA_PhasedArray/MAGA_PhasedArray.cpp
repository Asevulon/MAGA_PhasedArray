...
// MAGA_PhasedArray.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMAGAPhasedArrayApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMAGAPhasedArrayApp

CMAGAPhasedArrayApp::CMAGAPhasedArrayApp()
{
...
// Единственный объект CMAGAPhasedArrayApp

CMAGAPhasedArrayApp theApp;


// Инициализация CMAGAPhasedArrayApp

BOOL CMAGAPhasedArrayApp::InitInstance()
{
